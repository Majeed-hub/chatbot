...
{
    $id=$_GET['delete'];
    $mysqli->query("DELETE FROM u_queries WHERE id='$id'");

    echo "<script> alert('Query Deleted Successfully!'); window.location.href='manage_u_q.php'; </script>";
...
if(isset($_GET['edit']))
{
    $id=$_GET['edit'];
    $update=true;
    $result2=$mysqli->query("SELECT * FROM u_queries WHERE id='$id'");
...
if(isset($_POST['update']))
{
    ...
    echo "<script> alert('Query Added Successfully!'); window.location.href='manage_u_q.php'; </script>";
...
<html>
    <head>
    <title>ChatBot | Manage Unanswered</title>
        ...
        <header><img height="50" width="50" style="margin-right:20px;" src="ahm.png"><font color="white">Enquiry ChatBot</font></header>
            ...
            Home </a>
                ...
                <a href="manage_q.php" class="dashboard-nav-item"><i class="fas fa-edit"></i> Manage Queries
                    ...
                    href="manage_u_q.php" class="dashboard-nav-item active"><i class="fas fa-question"></i> Manage Unanswered Queries </a>
...
$query3="SELECT * FROM u_queries";

$result3=mysqli_query($connect,$query3);
?>
                        <h5 style="color:black;"><center><b> <i style="color:black;" class="fa fa-edit"></i> Manage Unanswered Query </b></center></h5>
...
<tr>
    ...
    <td>
<a class="btn btn-success" href="manage_u_q.php?edit=<?php echo $row->id?>">Add Answer</a>
  <a class="btn btn-danger" href="manage_u_q.php?delete=<?php echo $row->id?>">Delete</a>
   </td>
        </tr>
...
<input type="hidden" name="id" value="<?php echo $id; ?>">
        ...
        <center>Question:  <input style=" width:30%; " type="text" class="form-control"  placeholder="Question" name="question" value="<?php echo $question; ?>"  required></center>
        <br>
         <center>Answer:  <input style=" width:30%;  " type="text" class="form-control"  placeholder="Answer " name="answer"  required></center>
...
<?php 
if($update==true):?>
 <center> <input class="btn btn-warning" type="submit" name="update" value="Add Query" />
 </center> 
