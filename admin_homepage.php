...
<body>
    ...
    <div class='dashboard'>
        <div class="dashboard-nav">
            ...
            <nav class="dashboard-nav-list"><a href="admin_homepage.php" class="dashboard-nav-item active"><i class="fas fa-home"></i>
                    Home </a>
                ...
                </a><a href="manage_u_q.php" class="dashboard-nav-item"><i class="fas fa-question"></i> Manage Unanswered Queries </a>
                ...
                <a href="logout_handler.php" class="dashboard-nav-item"><i class="fas fa-sign-out-alt"></i> Logout </a>
            </nav>
        </div>
                ...
                <div class='container'>
                    ...
                    <div style="margin-left:60px;" class='card'>
                        <div class='card-header'>
                            <img src="ahm.png" height="200" width="200">
                        </div>
                        <div class='card-body'>
