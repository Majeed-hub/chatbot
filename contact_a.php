...
<html>
    ...
    <div class='dashboard'>
        ...
        <nav class="dashboard-nav-list"><a href="homepage.php" class="dashboard-nav-item"><i class="fas fa-home"></i>
            ...
            href="student_login.php" class="dashboard-nav-item"><i class="fas fa-robot"></i> Ask ChatBot </a>
               <!--<div class='dashboard-nav-dropdown'><a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i
                ...
                <a href="contact_a.php" class="dashboard-nav-item active"><i class="fas fa-phone"></i> Contact Us </a>
        ...
        <header style="" class='dashboard-toolbar'><a href="#!" class="menu-toggle"><i class="fas fa-bars"></i></a>AIMCA   Enquiry ChatBot | Anjuman Institute of Management & Computer Application, Bhatkal    </header> 
