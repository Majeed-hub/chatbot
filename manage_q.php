...
<html>
    <head>
    <title>ChatBot | Manage Queries</title>
 ...
 <nav class="dashboard-nav-list"><a href="admin_homepage.php" class="dashboard-nav-item"><i class="fas fa-home"></i>
            Home </a>
                ...
                <a href="manage_q.php" class="dashboard-nav-item active"><i class="fas fa-edit"></i> Manage Queries
            </a><a
...
?>
                        <h5 style="color:black;"><center><b> <i style="color:black;" class="fa fa-edit"></i> Manage Query </b></center></h5>
...
{
?><br>
    <h5 style="color:black;"><center><b> <i style="color:black;" class="fa fa-edit"></i> Update Query </b></center></h5>
