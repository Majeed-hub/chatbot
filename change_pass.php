...
if(isset($_POST['ch_button']))
{
    ...
    $result=$mysqli->query("SELECT * FROM admin_info WHERE  username='$profile' && password='$o_pass'") or die($mysqli->error());
    $row=$result->fetch_array();
    if($row==0)
    
        {
          echo "<script> alert('Old Password Does not Match!'); window.location.href='change_pass.php'; </script>";
        }
        ...
        $mysqli->query("UPDATE admin_info SET password='$n_pass'WHERE username='$profile'");
       
        echo "<script> alert('Password Changed Successfully!'); window.location.href='change_pass.php'; </script>";
      ...
      <div class='dashboard'>
        ...
        <nav class="dashboard-nav-list"><a href="admin_homepage.php" class="dashboard-nav-item"><i class="fas fa-home"></i>
               ...
               <!--<div class='dashboard-nav-dropdown'><a href="#!" class="dashboard-nav-item dashboard-nav-dropdown-toggle"><i
                ...
                <a href="#" class="dashboard-nav-item active"><i class="fas fa-key"></i> Change Password </a>
        ...
        <header style="margin-left:63.5px;" class='dashboard-toolbar'><a href="#!" class="menu-toggle"><i class="fas fa-bars"></i></a>AIMCA   Enquiry ChatBot  <a style="margin-left:650px;" href="" class="btn btn-primary"><i style="margin-right:5px;" class="fas fa-user"></i><?php echo $profile;?></a></header> 
            <div class='dashboard-content'>
                ...
                <div style="margin-left:60px;" class='card'>
                        ...
                        <h5 style="color:black;"><center><b> <i style="color:black;" class="fa fa-key"></i> Change Password </b></center></h5>
<br>

                        <form  action="" method="POST">


        <center> Old Password <input style="margin-bottom:10px;display:inline-block; width:30%; " type="text" class="form-control"  placeholder="Enter Your Old Password" name="o_pass"    required></center>

         <center> New Password <input style="margin-bottom:10px;display:inline-block; width:30%;  " type="text" class="form-control"  placeholder="Create New Password" name="n_pass"  required></center>
         <center> Confirm Password <input style="margin-bottom:10px;display:inline-block; width:30%;  " type="text" class="form-control"  placeholder="Confirm New Password" name="c_n_pass"  required></center>
<br>
         <center> <button class="btn btn-primary" type="submit" name="ch_button">Change Password</button>
 </center> 
</form>
